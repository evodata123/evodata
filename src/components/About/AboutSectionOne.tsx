              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Premium quality projects" />
                    <List text="Best Frameworks" />
                    <List text="State of the Art Analytics" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Complete Handholding" />
                    <List text="Customised Solutions" />
